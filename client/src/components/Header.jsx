...
const Header = () => {
  return (
    ...
    text-center my-20'>
        ...
        <h1 className='text-4xl max-w-[590px] sm:text-7xl sm:max-w-
        [590px] mx-auto mt-10 text-center'>Turn text to <span className='text-blue-600'>image</span>, in seconds.</h1>
      ...
      <p className='mt-2 text-neutral-600'>Generated images from 
      imagify</p>
